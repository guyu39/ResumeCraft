...
const EducationPreview: React.FC<EducationPreviewProps> = ({ items, themeColor, compact = false, title = '教育经历', moduleId, renderItemCommentIcon, renderItemCommentPanel }) => {
  const { t, te } = useI18n()
  ...
  const renderItemContent = (item: EducationItem) => (
    <>
      {/* 时间（右上角） */}
