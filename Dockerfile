...
RUN mkdir -p /home/appuser/.config/fontconfig && \
    printf '<?xml version="1.0"?>\n<!DOCTYPE fontconfig SYSTEM "fonts.dtd">\n<fontconfig>\n  <!-- 思源黑体 SC → Debian 内置 Noto CJK Sans（与 Source Han Sans 同源的开源 CJK 字体） -->\n  <alias><family>Source Han Sans SC</family><prefer><family>Noto Sans CJK SC</family><family>Noto Sans SC</family></prefer></alias>\n  <!-- 旧思源黑体名称 → 思源黑体 SC -->\n  <alias><family>Source Han Sans</family><prefer><family>Source Han Sans SC</family><family>Noto Sans CJK SC</family></prefer></alias>\n  <!-- 微软雅黑 → 思源黑体 SC -->\n  <alias><family>Microsoft YaHei</family><prefer><family>Source Han Sans SC</family><family>Noto Sans CJK SC</family></prefer></alias>\n  <!-- 宋体 → Noto Serif CJK SC -->\n  <alias><family>SimSun</family><prefer><family>Noto Serif CJK SC</family></prefer></alias>\n  <!-- 黑体 → 思源黑体 SC -->\n  <alias><family>SimHei</family><prefer><family>Source Han Sans SC</family><family>Noto Sans CJK SC</family></prefer></alias>\n  <!-- 楷体 → 思源黑体 SC（Linux 无自带楷体） -->\n  <alias><family>KaiTi</family><prefer><family>Source Han Sans SC</family><family>Noto Sans CJK SC</family></prefer></alias>\n  <!-- 苹方 → 思源黑体 SC -->\n  <alias><family>PingFang SC</family><prefer><family>Source Han Sans SC</family><family>Noto Sans CJK SC</family></prefer></alias>\n</fontconfig>\n' > /home/appuser/.config/fontconfig/fonts.conf && \
